...
# more". The bundles are always a fixed 40 (32 + 6 + 2 = 810 SP), mirroring
# the XP-tome split (32 Tattered / 6 Worn / 2 Ancient); the single
...
SP_ITEMS: Tuple[Tuple[str, int, int, Optional[int]], ...] = (
    ...
    ("Skillpoint Bundle (Medium)", 1, 25,  6),
...
def fixed_bundle_names() -> List[str]:
    """Flat list of the 40 always-present fixed bundles (Small x32, Medium x6,
