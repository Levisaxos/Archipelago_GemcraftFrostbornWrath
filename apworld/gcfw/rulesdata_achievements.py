...
Fields per achievement (in file order):
  ...
  series           - (optional, not used by logic yet) Name of the step-1
                     achievement of the tiered series this one belongs to
                     (same goal, rising threshold), e.g. "Charged for the Kill".
  series_step      - (optional, paired with series) 1-based position in that
                     series, ordered by threshold: Charged for the Kill 1,
                     Deathball 2, Bouncy Zap 3, Pylons of Destruction 4.
  trigger          - (not used by logic yet) When vanilla evaluates the
                     achievement and can pop it, derived from the decompiled
                     source by do not commit/py-scripts/extract_achievement_triggers.py:
                       "on battle start" - checked once as the battle starts (IngameAchiCtrl.checkAchisAtStart)
                       "during play"     - checked live, by a game event or the per-frame stat poll
                       "on victory"      - checked only when the battle is won (checkAchisAtTrueVictory, or the checker needs isBattleWon)
                       "on defeat"       - checked only when the orb is destroyed (endGameWithDefeat)
                       "on battle end"   - no live check; only the end-of-battle sweep (win or lose) catches it
                     Every trigger still only banks the achievement when the battle ends, and the mod sends the AP check then.
"""
...
achievement_requirements = {
    ...
    "One by One": {
        ...
        "requirements": ["minMonsters:750", "min_wl:100"],
        "required_effort": "Major",
        "trigger": "during play",
        "series": "Puncturing Shots",
        "series_step": 3,
    ...
    "Omnibomb": {
        ...
        "requirements": [
            ["tRitual", "eBeacon:1"], #requires specific levels.. not all levels with eBeacon can do this achievement.            
    ...
    "It was Abandoned Anyway": {
        ...
        "required_effort": "Trivial",
        "trigger": "during play",
        "series": "It was Abandoned Anyway",
        "series_step": 1,
    },
    "Busted": {
        "ap_id": 2072,
    ...
    "No You Won't!": {
        ...
        "requirements": ["sBolt", "eWatchtower", "min_wl:80"],
        "required_effort": "Major",
        "trigger": "during play",
    },
    "Flying Multikill": {
    ...
    "I am Tougher": {
        ...
        "requirements": ["tRitual", "eWraith", "minMonsters:1600"],
        "required_effort": "Extreme",
        "trigger": "during play",
        "series": "Twice the Steepness",
        "series_step": 4,
    },
    "Waspocalypse": {
        "ap_id": 2601,
    ...
    "Glitter Cloud": {
        ...
        "requirements": ["tRitual", "eApparition:1"],
        "required_effort": "Minor",
        "trigger": "during play",
    },
    "End of the Tunnel": {
    ...
    "Purged": {
        ...
        "requirements": ["markedMonster:179"],
        "required_effort": "Major",
        "trigger": "during play",
    },
    "Avenged": {
    ...
    "Ok Flier": {
        ...
        "requirements": ["tRitual", "eWraith", "minMonsters:680"],
        "required_effort": "Extreme",
        "trigger": "during play",
        "series": "Twice the Steepness",
        "series_step": 2,
    ...
    "Hunt For Hard Targets": {
        ...
        "requirements": ["tRitual", "eWraith", "minMonsters:1360"],
        "required_effort": "Extreme",
        "trigger": "during play",
        "series": "Twice the Steepness",
        "series_step": 3,
    ...
    "Thunderstruck": {
        ...
        "requirements": ["minMonsters:120", "min_wl:30"],
        "required_effort": "Minor",
        "trigger": "during play",
        "series": "From Above",
        "series_step": 2,
    ...
    "Wasp Storm": {
        ...
        "requirements": ["minMonsters:360", "min_wl:60"],
        "required_effort": "Major",
        "trigger": "during play",
        "series": "From Above",
        "series_step": 3,
    ...
    "Blastwave": {
        ...
        "requirements": ["eShrine", "min_wl:50"],
        "required_effort": "Major",
        "trigger": "on battle end",
        "series": "Blastwave",
        "series_step": 1,
    ...
    "High Targets": {
        ...
        "requirements": ["tRitual", "eNonMonsters:1", "min_wl:20"],
        "required_effort": "Minor",
        "trigger": "on battle end",
        "series": "Smoke in the Sky",
        "series_step": 2,
    ...
    "Wings and Tentacles": {
        ...
        "requirements": ["tRitual", "eNonMonsters:1", "min_wl:30"],
        "required_effort": "Major",
        "trigger": "on battle end",
        "series": "Smoke in the Sky",
        "series_step": 3,
    ...
    "Paranormal Paragon": {
        ...
        "requirements": ["tRitual", "eNonMonsters:1", "min_wl:50"],
        "required_effort": "Extreme",
        "trigger": "on battle end",
        "series": "Smoke in the Sky",
        "series_step": 4,
    ...
    "Miniblasts": {
        ...
        "requirements": ["sArmorTearing", "min_wl:40"],
        "required_effort": "Minor",
        "trigger": "on battle end",
        "series": "Miniblasts",
        "series_step": 1,
    ...
    "Punching Deep": {
        ...
        "requirements": ["sArmorTearing", "min_wl:50"],
        "required_effort": "Major",
        "trigger": "on battle end",
        "series": "Miniblasts",
        "series_step": 2,
    ...
    "Corrosive Stings": {
        ...
        "requirements": ["sArmorTearing", "min_wl:60"],
        "required_effort": "Major",
        "trigger": "on battle end",
        "series": "Miniblasts",
        "series_step": 3,
    ...
    "Melting Armor": {
        ...
        "requirements": ["sArmorTearing", "min_wl:70"],
        "required_effort": "Extreme",
        "trigger": "on battle end",
        "series": "Miniblasts",
        "series_step": 4,
