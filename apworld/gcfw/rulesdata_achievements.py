...
achievement_requirements = {
    ...
    "Black Blood": {
        ...
        "requirements": [
            ["Poison skill", "Ritual trait", "Shadow element"],
            ["Poison skill", "Shadow element"],
        ],
        "reward": "skillPoints:2",
        "required_power": 30,
        "required_effort": "Trivial",
    ...
    "Cleansing the Wilderness": {
        ...
        "untrackable": True,
        "requirements": [
            ["Endurance", "Possessed Monster element", "minWave: 70"],
            ["Endurance", "Twisted Monster element", "minWave: 70"],
            ["Endurance", "Marked Monster element", "minWave: 70"],
        ],
        "reward": "skillPoints:1",
        "required_effort": "Extreme",
    },
