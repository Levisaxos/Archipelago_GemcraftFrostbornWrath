package ui {
    ...
    /**
     * Manages the Credits / Thanks panel lifecycle.
     *
     * Wraps McCredits (which uses the game's McOptions chrome).
     * Scroll / drag / viewport logic is handled by the ScrollablePanel helper.
     *
     * Usage:
     *   var scr:ScrCredits = new ScrCredits();
     *   scr.populate(CreditsData.getSections());
    ...
    public class ScrCredits {
        ...
        /**
         * Build (or rebuild) the panel from a sections array.
         * Safe to call while showing — closes and reopens with fresh content.
         */
        public function populate(sections:Array):void {
