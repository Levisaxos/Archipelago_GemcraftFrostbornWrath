package data {
    ...
    public class EmbeddedData {
        ...
        [Embed(source="json/achievement_progress.json", mimeType="application/octet-stream")]
        private static var AchievementProgressBytes:Class;
        ...
        /**
         * Get the achievement_progress.json content as a string.
         * Maps vanilla achievement game_id -> the cumulative GV.ppd.stats index
         * and target threshold for "Reach N" achievements, so the panel can draw
         * an always-visible progress bar on them. Generated by
         * do not commit/py-scripts/extract_achievement_progress.py.
         */
        public static function getAchievementProgressJSON():String {
            var bytes:* = new AchievementProgressBytes();
            return bytes.readUTFBytes(bytes.length);
        }
    }
}
